...
namespace WindowsFormsApplication1
{
    public class GetHTML
    {
        ...
        public GetHTML()
        {
            SetHTML("https://list.lu.com/list/transfer-p2p?minMoney=&maxMoney=&minDays=&maxDays=&minRate=&maxRate=&mode=&tradingMode=&isCx=&currentPage=1&orderCondition=INVEST_RATE_DESC&isShared=&canRealized=&productCategoryEnum=");
        }
        ...
        private void SetHTML(string h)
        {
            try
            {
                ...
                //从指定网站下载数据
                Byte[] pageData = myWebClient.DownloadData(h);
